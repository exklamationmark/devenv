...
# JVM_OPTS="$JVM_OPTS -javaagent:$CASSANDRA_HOME/lib/jamm-0.3.0.jar=6666:/etc/cassandra/jmxremote.yml'" # default value
# run jmx_exporter java agent to export metrics
EXPORTER_AGENT="/usr/share/cassandra/jmx_exporter/javaagent-0.11.0.jar"
EXPORTER_CONFIG="/usr/share/cassandra/jmx_exporter/config.yml"
EXPORTER_PORT=6666
JVM_OPTS="$JVM_OPTS -javaagent:$EXPORTER_AGENT=$EXPORTER_PORT:$EXPORTER_CONFIG"
...
if [ "$LOCAL_JMX" = "yes" ]; then
  ...
  # JVM_OPTS="$JVM_OPTS -Dcom.sun.management.jmxremote.host=0.0.0.0"
